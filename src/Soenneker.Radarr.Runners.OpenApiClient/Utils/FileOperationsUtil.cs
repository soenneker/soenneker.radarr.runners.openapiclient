...
using Soenneker.Radarr.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Radarr.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Radarr:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/Radarr/Radarr/develop/src/Radarr.Api.V3/openapi.json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c RadarrOpenApiClient -n {Constants.Library}",
